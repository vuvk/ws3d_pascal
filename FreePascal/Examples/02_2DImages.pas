...
var
  Planet:wTexture			=nil;
  Alien_face:wTexture		        =nil;
  Crosshair:wTexture		        =nil;
  Power_icon:wTexture		        =nil;
  Teleport_icon:wTexture	        =nil;
  Worldsim3d_logo:wTexture	        =nil;

  myFont:wFont				=nil;

  GUIEvent:PwGuiEvent	                =nil;
  skin:wGuiObject                       =nil;
  labelAlpha:wGuiObject                 =nil;
  labelRed:wGuiObject                   =nil;
  labelGreen:wGuiObject                 =nil;
  labelBlue:wGuiObject                  =nil;
  scroll_alpha:wGuiObject               =nil;
  scroll_red:wGuiObject                 =nil;
  scroll_green:wGuiObject               =nil;
  scroll_blue:wGuiObject                =nil;
  ...
  texPath3:PChar='../../Assets/Sprites/crosshair.png';
...
begin
  ...
  labelAlpha:=wGuiLabelCreate(WStr('A'),fromPos,toPos);
  ...
  labelRed:=wGuiLabelCreate(WStr('R'),fromPos,toPos);
  ...
  labelGreen:=wGuiLabelCreate(WStr('G'),fromPos,toPos);
  ...
  labelBlue:=wGuiLabelCreate(WStr('B'),fromPos,toPos);
