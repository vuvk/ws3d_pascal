...
begin
  ...
  for i := 0 to wNodeGetMaterialsCount(WaterNode) - 1 do
    begin
      ...
      wMaterialScaleTexture(material,1,texScale1);
    end;

  ///Create camera
  Camera := wFpsCameraCreate(100, 0.1, PwKeyMapDefault, Length(wKeyMapDefault));
    ...
    begin
          ...
          case (waterType) of
            ...
            2:
              begin
                ...
                wMaterialScaleTexture(material,1,texScale2);
              end;
          end;
        end;
      ...
      if (waterType = 2) then
        begin
          ...
          wMaterialTranslateTexture(material,1,waterTranslate);
        end;
